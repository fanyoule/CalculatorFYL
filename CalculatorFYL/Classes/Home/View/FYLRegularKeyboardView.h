...
@protocol FYLRegularKeyboardViewdelegate <NSObject>

-(void)fyl_RegularKeyboardDidSelectedButton:(UIButton *)btn;

@end
@interface FYLRegularKeyboardView : UIView
@property(nonatomic,weak)id<FYLRegularKeyboardViewdelegate>delegate;
