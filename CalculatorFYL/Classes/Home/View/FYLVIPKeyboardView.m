...
@implementation FYLVIPKeyboardView
...
-(void)initializeData{
    ...
    [self.itemArray addObject:self.B_bfbi];
    [self.itemArray addObject:self.B_kh];
    ...
    UILongPressGestureRecognizer *longPressGesture_B_kh = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(longPressAction:)];
    [self.B_kh addGestureRecognizer:longPressGesture_B_kh];
    UILongPressGestureRecognizer *longPressGesture_B_bfb = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(longPressAction:)];
