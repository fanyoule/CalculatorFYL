...
//    _image_icon = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"input_bg"]];
...
//    self.image_icon.frame = CGRectMake(0, 0, self.frame.size.height, self.frame.size.width);
